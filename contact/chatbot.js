...
제2조 【대금 지불】
계약금은 7만 원이며 계약 체결 후 반환은 불가합니다. 예식일 변경 시에도 동일하게 적용됩니다(천재지변이나 예식장 폐쇄의 경우 환불 가능합니다). 계약금 외 잔금 70만 원은 촬영 1주일 전에 안내드리는 계좌번호로 예식 3일 전까지 완납해 주시는 것을 원칙으로 합니다. 현금영수증, 세금계산서를 원하실 경우 VAT(부가세)는 별도입니다.
...
제6조 【촬영 관련】
본식 영상의 음성은 메인 카메라 장착 샷건 마이크 및 서브 카메라의 마이크로 수음되며, 고음질 녹음기는 하이라이트 영상에 나레이션으로 사용할 경우에만 활용되고 식장 상황에 따라 활용되지 않을 수도 있으며 원본은 별도로 보관하지 않습니다. 메인 카메라는 모노포드를 사용하여 식 전반을 촬영하고, 서브 카메라 한 대는 본식을 끊김없이 촬영하기 위해 식장 전방에 삼각대로 고정 배치하며 서브 카메라 한 대는 단상을 향하게 배치합니다. 두 대의 오즈모 카메라는 양가 부모님을 담기 위해 각각 한 대씩 배치됩니다. '인터뷰' 옵션은 전용 무선 마이크를 통해 선명하고 고품질의 음성으로 신랑·신부 양가 부모님과 각 측 지인 한 팀씩의 인터뷰를 촬영합니다. 단, 현장 상황이나 인터뷰 거부 등으로 인해 촬영 인원은 유동적으로 조정될 수 있습니다. 대표 촬영은 '코스보스 웨딩필름 창업자' 1인 또는 공동 대표 '안준우' 1인의 촬영을 의미합니다.
