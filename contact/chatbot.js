...
제2조 【대금 지불】
계약금은 7만 원이며 계약 체결 후 반환은 불가합니다. 예식일 변경 시에도 동일하게 적용됩니다(천재지변이나 예식장 폐쇄의 경우 환불 가능합니다). 계약금 외 잔금 61만 원은 촬영 1주일 전에 안내드리는 계좌번호로 예식 3일 전까지 완납해 주시는 것을 원칙으로 합니다. 현금영수증, 세금계산서를 원하실 경우 VAT(부가세)는 별도입니다.
